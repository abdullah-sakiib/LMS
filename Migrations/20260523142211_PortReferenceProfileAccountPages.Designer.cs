...
namespace LMS.Migrations
{
    ...
    [Migration("20260523142211_PortReferenceProfileAccountPages")]
    partial class PortReferenceProfileAccountPages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LMS.Models.CourseDiscussionPost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("CourseDiscussionPosts");
                });

            modelBuilder.Entity("LMS.Models.CourseReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LMS.Models.QuizResponse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<double>("AwardedMarks")
                        .HasColumnType("double precision");
            ...
            modelBuilder.Entity("LMS.Models.CourseDiscussionPost", b =>
                {
                    b.HasOne("LMS.Models.ApplicationUser", "Author")
                        .WithMany()
            ...
            modelBuilder.Entity("LMS.Models.QuizResponse", b =>
                {
                    ...
                    b.HasOne("LMS.Models.QuizOption", "SelectedOption")
                        .WithMany()
